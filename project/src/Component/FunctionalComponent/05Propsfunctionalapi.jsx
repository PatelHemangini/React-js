...
import CustomCard from "./05CustomCardApi"
import Propsapi from "./"
const Propsfunctionalapi=(val)=>{
...
let ProductListdata=data.map((kaipan)=>{
   ...
   return(
    <>
    <button onClick={Propsapi}>ProductApi</button>
    <div className="row">
        {ProductListdata}
    </div>
...
export default Propsfunctionalapi;